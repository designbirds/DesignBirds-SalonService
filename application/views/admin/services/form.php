	...
	<fieldset class="form-fields">
		...
		<div id="field-name" class="control-group">
			<div class="controls">
				...
				<input type="text" id="service-name" name="name" placeholder="Service Name" value="<?php echo set_value('name', $service['name']); ?>" />
		...
		<div id="field-name" class="control-group">
			<div class="controls">
				...
				<input type="text" id="service-description" name="description" placeholder="Service description" value="<?php echo set_value('description', $service['description']); ?>" />
